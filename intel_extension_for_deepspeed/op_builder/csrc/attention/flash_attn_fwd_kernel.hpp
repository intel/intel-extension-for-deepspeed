...
public:
    ...
    struct arguments_t {
        ...
        arguments_t(uint32_t batch_dim_, const uint32_t head_dim_,
                uint32_t sequence_length_, float hs_rsqrt_scale_,
                dtype_q *ptr_q_, dtype_k *ptr_k_, dtype_v *ptr_v_,
                dtype_o *ptr_o_, dtype_m *ptr_m_, dtype_b *ptr_b_)
    ...
    template <uint32_t m_w_, uint32_t n_w_, uint32_t k_w_, uint32_t n_s_,
            uint32_t k_s_>
    struct param_S_t {
        using compute_attr = gpu::xetla::group::compute_attr_t<dtype_q, dtype_k,
                dtype_acc>;
        struct fine_tuning {
        ...
        using perf_tuning_knob
                = gpu::xetla::group::perf_tuning_knob_t<k_iter_num,
                        fine_tuning::prefetch_distance,
                        fine_tuning::periodic_sync_interval>;
        using compute_policy
                = gpu::xetla::group::compute_policy_default_xmx<compute_attr,
                        perf_tuning_knob, gpu::xetla::gpu_arch::Xe>;
        using mem_desc_input_q = gpu::xetla::mem_desc_t<dtype_q,
                gpu::xetla::mem_layout::row_major,
                gpu::xetla::mem_space::global>;
        using mem_desc_input_k = gpu::xetla::mem_desc_t<dtype_k,
        ...
        static_assert(m_w * n_w % (n_s * thread_num) == 0,
        ...
        using brgemm_t = gpu::xetla::group::brgemm_t<compute_policy, tile_shape,
                mem_desc_input_q, mem_desc_input_k>;
    ...
    using param_S = param_S_t<B_r, B_c, H, tuning_parameter::matS_n_s,
    ...
    struct param_P {
        ...
        using rowmax_t = gpu::xetla::xetla_vector<typename mat_out_t::dtype,
                mat_in_t::tile_size_y>;
        using rowsum_t = rowmax_t;
        static constexpr int vec_length = rowmax_t::length;
        using vec_dtype = rowmax_t::element_type;

        using mem_desc_output_m = gpu::xetla::mem_desc_t<dtype_m,
                gpu::xetla::mem_layout::row_major,
                gpu::xetla::mem_space::global>;
        using factor_tile_desc_t = gpu::xetla::subgroup::tile_desc_t<vec_length,
                1, vec_length, 1, gpu::xetla::reg_layout::tiled>;
        using factor_tile_t
                = gpu::xetla::subgroup::tile_t<dtype_m, factor_tile_desc_t>;
        using factor_payload_t = gpu::xetla::subgroup::mem_payload_t<dtype_m,
                factor_tile_desc_t, gpu::xetla::msg_type::block_1d,
                mem_desc_output_m::layout, mem_desc_output_m::space,
        ...
        using wg_reduce_max_t
                = gpu::xetla::group::group_reduce_t<typename mat_out_t::dtype,
                        1, vec_length, gpu::xetla::reduce_op::max,
                        reduce_list_xlength, true, factor_payload_t::arch_tag>;
        using wg_reduce_sum_t
                = gpu::xetla::group::group_reduce_t<typename mat_out_t::dtype,
                        1, vec_length, gpu::xetla::reduce_op::sum,
                        reduce_list_xlength, true, factor_payload_t::arch_tag>;

        using reduce_nbarrier_t
                = gpu::xetla::xetla_nbarrier_t<reduce_list_xlength,
                        reduce_list_xlength>;
    ...
    struct param_O_t {
        using compute_attr = gpu::xetla::group::compute_attr_t<dtype_p,
                dtype_acc, dtype_acc>;
        struct fine_tuning {
            static constexpr uint32_t periodic_sync_interval = 8;
            static constexpr uint32_t prefetch_distance = 3;
        ...
        using mem_desc_input_p = gpu::xetla::mem_desc_t<dtype_m,
                gpu::xetla::mem_layout::row_major,
                gpu::xetla::mem_space::global>;
        using mem_desc_input_v = gpu::xetla::mem_desc_t<dtype_v,
                gpu::xetla::mem_layout::row_major,
                gpu::xetla::mem_space::global>;
        static constexpr int m_w = m_w_;
        static constexpr int n_w = n_w_;
        ...
        using tile_shape = gpu::xetla::group::tile_shape_t<n_w, m_w, n_s, m_s>;
        using brgemm_t = gpu::xetla::group::brgemm_t<compute_policy, tile_shape,
                mem_desc_input_p, mem_desc_input_v>;
        using mat_out_t = brgemm_t::matAcc_t;
        static constexpr int split_k_cnt = k_w_ / k_iter_num;
        static constexpr int barrier_count = brgemm_t::barrier_count;
        static constexpr int slm_size = brgemm_t::slm_size;
    ...
    using param_O = param_O_t<param_S::m_w, H, param_S::n_w,
