...
__inline__ void load_global(void* dst, const void* src);

template <int AccessSize, LoadPolicy policy = LoadPolicy::CacheAll>
__inline__ void load_global(void* dst, const void* src, bool do_access);

// Shared accesses have no cache policy
template <int AccessSize>
__inline__ void load_shared(void* dst, const void* src);

template <int AccessSize>
__inline__ void load_shared(void* dst, const void* src, bool do_access);

template <int AccessSize, StorePolicy policy = StorePolicy::Writeback>
__inline__ void store_global(void* dst, const void* src);

// Shared accesses have no cache policy
template <int AccessSize>
__inline__ void store_shared(void* dst, const void* src);
...
public:
    ...
    __inline__ BufferTracker() : current_state(0) {}
...
/////////// Load Global ///////////
template <>
__inline__ void load_global<16>(void* dst, const void* src)
{
...
template <>
__inline__ void load_global<16>(void* dst, const void* src, bool do_access)
{
    sycl::uint4* data = reinterpret_cast<sycl::uint4*>(dst);
#ifdef PTX_AVAILABLE
    asm volatile(
...
template <>
__inline__ void load_global<16, LoadPolicy::CacheGlobal>(void* dst, const void* src)
{
    sycl::uint4* data = reinterpret_cast<sycl::uint4*>(dst);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void load_global<16, LoadPolicy::CacheGlobal>(void* dst,
                                                              const void* src,
                                                              bool do_access)
{
    sycl::uint4* data = reinterpret_cast<sycl::uint4*>(dst);
...
template <>
__inline__ void load_global<16, LoadPolicy::CacheStreaming>(void* dst, const void* src)
{
    sycl::uint4* data = reinterpret_cast<sycl::uint4*>(dst);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void load_global<16, LoadPolicy::CacheStreaming>(void* dst,
                                                                 const void* src,
                                                                 bool do_access)
{
    sycl::uint4* data = reinterpret_cast<sycl::uint4*>(dst);
...
template <>
__inline__ void load_global<8>(void* dst, const void* src)
{
...
template <>
__inline__ void load_global<8>(void* dst, const void* src, bool do_access)
{
    sycl::uint2* data = reinterpret_cast<sycl::uint2*>(dst);
#ifdef PTX_AVAILABLE
    asm volatile(
...
template <>
__inline__ void load_global<8, LoadPolicy::CacheGlobal>(void* dst, const void* src)
{
    sycl::uint2* data = reinterpret_cast<sycl::uint2*>(dst);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void load_global<8, LoadPolicy::CacheGlobal>(void* dst,
                                                             const void* src,
                                                             bool do_access)
{
    sycl::uint2* data = reinterpret_cast<sycl::uint2*>(dst);
...
template <>
__inline__ void load_global<8, LoadPolicy::CacheStreaming>(void* dst, const void* src)
{
    sycl::uint2* data = reinterpret_cast<sycl::uint2*>(dst);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void load_global<8, LoadPolicy::CacheStreaming>(void* dst,
                                                                const void* src,
                                                                bool do_access)
{
    sycl::uint2* data = reinterpret_cast<sycl::uint2*>(dst);
...
template <>
__inline__ void load_global<4>(void* dst, const void* src)
{
...
template <>
__inline__ void load_global<4>(void* dst, const void* src, bool do_access)
{
    int32_t* data = reinterpret_cast<int32_t*>(dst);
#ifdef PTX_AVAILABLE
    asm volatile(
...
template <>
__inline__ void load_global<4, LoadPolicy::CacheGlobal>(void* dst, const void* src)
{
    int32_t* data = reinterpret_cast<int32_t*>(dst);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void load_global<4, LoadPolicy::CacheGlobal>(void* dst,
                                                             const void* src,
                                                             bool do_access)
{
    int32_t* data = reinterpret_cast<int32_t*>(dst);
...
template <>
__inline__ void load_global<4, LoadPolicy::CacheStreaming>(void* dst, const void* src)
{
    int32_t* data = reinterpret_cast<int32_t*>(dst);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void load_global<4, LoadPolicy::CacheStreaming>(void* dst,
                                                                const void* src,
                                                                bool do_access)
{
    int32_t* data = reinterpret_cast<int32_t*>(dst);
...
template <>
__inline__ void load_global<2>(void* dst, const void* src)
{
...
template <>
__inline__ void load_global<2>(void* dst, const void* src, bool do_access)
{
    int16_t* data = reinterpret_cast<int16_t*>(dst);
#ifdef PTX_AVAILABLE
    asm volatile(
...
template <>
__inline__ void load_global<2, LoadPolicy::CacheGlobal>(void* dst, const void* src)
{
    int16_t* data = reinterpret_cast<int16_t*>(dst);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void load_global<2, LoadPolicy::CacheGlobal>(void* dst,
                                                             const void* src,
                                                             bool do_access)
{
    int16_t* data = reinterpret_cast<int16_t*>(dst);
...
template <>
__inline__ void load_global<2, LoadPolicy::CacheStreaming>(void* dst, const void* src)
{
    int16_t* data = reinterpret_cast<int16_t*>(dst);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void load_global<2, LoadPolicy::CacheStreaming>(void* dst,
                                                                const void* src,
                                                                bool do_access)
{
    int16_t* data = reinterpret_cast<int16_t*>(dst);
...
template <>
__inline__ void load_shared<16>(void* dst, const void* src)
{
    sycl::uint4* data = reinterpret_cast<sycl::uint4*>(dst);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void load_shared<16>(void* dst, const void* src, bool do_access)
{
    sycl::uint4* data = reinterpret_cast<sycl::uint4*>(dst);
#ifdef PTX_AVAILABLE
    unsigned src_shr = internal::convert_to_shared(src);
...
template <>
__inline__ void load_shared<8>(void* dst, const void* src)
{
    sycl::uint2* data = reinterpret_cast<sycl::uint2*>(dst);
#ifdef PTX_AVAILABLE
    unsigned src_shr = internal::convert_to_shared(src);
...
template <>
__inline__ void load_shared<8>(void* dst, const void* src, bool do_access)
{
    sycl::uint2* data = reinterpret_cast<sycl::uint2*>(dst);
#ifdef PTX_AVAILABLE
    unsigned src_shr = internal::convert_to_shared(src);
...
template <>
__inline__ void load_shared<4>(void* dst, const void* src)
{
    int32_t* data = reinterpret_cast<int32_t*>(dst);
#ifdef PTX_AVAILABLE
    unsigned src_shr = internal::convert_to_shared(src);
...
template <>
__inline__ void load_shared<4>(void* dst, const void* src, bool do_access)
{
    int32_t* data = reinterpret_cast<int32_t*>(dst);
#ifdef PTX_AVAILABLE
    unsigned src_shr = internal::convert_to_shared(src);
...
template <>
__inline__ void store_global<16>(void* dst, const void* src)
{
...
template <>
__inline__ void store_global<16, StorePolicy::CacheGlobal>(void* dst, const void* src)
{
    const sycl::uint4* data = reinterpret_cast<const sycl::uint4*>(src);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void store_global<16, StorePolicy::CacheStreaming>(void* dst, const void* src)
{
    const sycl::uint4* data = reinterpret_cast<const sycl::uint4*>(src);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void store_global<8>(void* dst, const void* src)
{
...
template <>
__inline__ void store_global<8, StorePolicy::CacheGlobal>(void* dst, const void* src)
{
    const sycl::uint2* data = reinterpret_cast<const sycl::uint2*>(src);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void store_global<8, StorePolicy::CacheStreaming>(void* dst, const void* src)
{
    const sycl::uint2* data = reinterpret_cast<const sycl::uint2*>(src);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void store_global<4>(void* dst, const void* src)
{
...
template <>
__inline__ void store_global<4, StorePolicy::CacheGlobal>(void* dst, const void* src)
{
    const int32_t* data = reinterpret_cast<const int32_t*>(src);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void store_global<4, StorePolicy::CacheStreaming>(void* dst, const void* src)
{
    const int32_t* data = reinterpret_cast<const int32_t*>(src);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void store_shared<16>(void* dst, const void* src)
{
    const sycl::uint4* data = reinterpret_cast<const sycl::uint4*>(src);
#ifdef PTX_AVAILABLE
...
template <>
__inline__ void store_shared<8>(void* dst, const void* src)
{
    const sycl::uint2* data = reinterpret_cast<const sycl::uint2*>(src);
#ifdef PTX_AVAILABLE
    unsigned dst_int = internal::convert_to_shared(dst);
...
template <>
__inline__ void store_shared<4>(void* dst, const void* src)
{
    const int32_t* data = reinterpret_cast<const int32_t*>(src);
#ifdef PTX_AVAILABLE
    unsigned dst_int = internal::convert_to_shared(dst);
