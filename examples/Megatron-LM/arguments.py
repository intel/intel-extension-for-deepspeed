...
def add_bf16_config_args(parser):
    """Mixed precision arguments."""

    group = parser.add_argument_group('bf16', 'bf16 configurations')
...
def add_training_args(parser):
    ...
    group.add_argument('--disable-sysmon', action='store_true',
                       help='#check the GPU memory after each iteration')
...
def get_args():
    ...
    parser = add_bf16_config_args(parser)
    ...
    args.cuda = get_accelerator().is_available()
